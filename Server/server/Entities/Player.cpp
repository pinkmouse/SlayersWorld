    ...
    m_AccountID(p_AccountID)
{
    ...
    WebHook::sendMsg(g_Config->GetValue("WebhookUrl"), "Connection : " + m_Name + ":" + std::to_string(p_ID) + "   Total : " + std::to_string(g_MapManager->GetTotalPlayers()));
}
...
Player::~Player()
{
    ...
    WebHook::sendMsg(g_Config->GetValue("WebhookUrl"), "Deconnection : " + m_Name + ":" + std::to_string(GetID()) + "   Total : " + std::to_string(g_MapManager->GetTotalPlayers()));
