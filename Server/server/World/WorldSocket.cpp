...
void WorldSocket::SendUnitCreate(uint8 p_Type, uint32 p_ID, std::string p_Name, uint8 p_Level, uint8 p_Health,  uint8 p_Mana, uint8 p_Alignment, uint8 p_SkinID, uint8 p_SizeX, uint8 p_SizeY, uint8 p_Speed, uint16 p_MapID, Position p_Position, uint8 p_Orientation, bool p_InMovement, bool p_IsAttacking)
{
    ...
    l_Packet.BuildPacket(p_Type, p_ID, p_Name, p_Level, p_Level, p_Mana, p_Alignment, p_SkinID, p_SizeX, p_SizeY, p_Speed, p_MapID, p_Position, p_Orientation, p_InMovement, p_IsAttacking);
